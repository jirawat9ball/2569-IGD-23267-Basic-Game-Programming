...
public class Assignment_Submitter_Week06 : MonoBehaviour
{
    ...
    {
        Debug.Log($"⏳ กำลังส่งงาน Week 06... (คะแนนที่ได้ {score}/{maxScore})");
        ...
        updateCallback = () =>
        {
            if (www.isDone)
            {
                ...
                {
                    Debug.Log("<color=green>✅ ส่งงานเรียบร้อยแล้ว!</color> ข้อมูลถูกบันทึกลง Google Sheet แท็บ Week06");
                }
                www.Dispose();
