...
public class Assignment_SubmitterEditor_Week05 : Editor
{
    ...
    private static bool ValidateSubmitter(Assignment_Submitter_Week05 submitter)
    {
        ...
        if (submitter.section == Assignment_Submitter_Week05.StudentSection.Other && string.IsNullOrEmpty(submitter.customSection))
        {
    ...
    private static void RunTestsAndSubmit(Assignment_Submitter_Week05 submitter)
    {
        ...
        receiver.sectionString = (submitter.section == Assignment_Submitter_Week05.StudentSection.Other)
            ? submitter.customSection
            : submitter.section.ToString().Replace("_", " ");
        receiver.weekName = submitter.weekName;

        var prop = typeof(Assignment_Submitter_Week05).GetProperty("googleSheetWebAppURL",
